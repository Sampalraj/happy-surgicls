...
import { Target, Eye, Award, Users, CheckCircle, ArrowRight, TrendingUp, ShieldCheck } from 'lucide-react';
...
const About = () => {
    ...
    const icons = [<Award key="1" />, <Users key="2" />, <TrendingUp key="3" />, <ShieldCheck key="4" />];
        ...
        <div className="about-page">
            ...
            <div className="about-hero">
                <div className="container">
                    <h4 style={{ color: '#666', marginBottom: '1rem' }}>{content.title || 'About Us'}</h4>
